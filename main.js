...
class CssEditorPlugin extends obsidian.Plugin {
    async onload() {
        console.log("✅ CSS Editor Plugin loaded");
        this.addSettingTab(new CssEditorSettingTab(this.app, this));
    }
}
class CssEditorSettingTab extends obsidian.PluginSettingTab {
    constructor(app, plugin) {
        super(app, plugin);
        this.filePath = `${this.app.vault.configDir}/snippets/css-editor.css`;
        this.editedBlocks = [];
        this.searchQuery = "";
        this.plugin = plugin;
    }
    async display() {
        ...
        addButton.onclick = async () => {
            new AddBlockModal(this.app, async (name, selector, description) => {
                const newBlock = { name, selector, body: `  /* your styles here */`, description };
        ...
        importBtn.onclick = async () => {
            try {
                ...
                await this.saveBlocks();
                await this.display();
                new obsidian.Notice("✅ Imported CSS blocks.");
            }
            catch (e) {
                console.error(e);
                new obsidian.Notice("❌ Failed to import file.");
            }
        };
        ...
        exportBtn.onclick = async () => {
            try {
                ...
                new obsidian.Notice("✅ Exported CSS blocks.");
            }
            catch (e) {
                console.error(e);
                new obsidian.Notice("❌ Failed to export file.");
            }
        };
...
class AddBlockModal extends obsidian.Modal {
    constructor(app, onSubmit, initial) {
        super(app);
    ...
    onOpen() {
        ...
        new obsidian.Setting(contentEl)
            .addButton((btn) => btn.setButtonText(this.initial ? "Save" : "Add")
            .setCta()
            .onClick(() => {
            this.close();
...
module.exports = CssEditorPlugin;
